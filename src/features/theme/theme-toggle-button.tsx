...
export function ThemeToggleButton(
  ...
  return (
    <Button
      ...
      {...props}
    >
      <Sun className="h-[1.2rem] w-[1.2rem] scale-100 rotate-0 transition-all duration-500 dark:scale-0 dark:-rotate-180" />
      <Moon className="absolute h-[1.2rem] w-[1.2rem] scale-0 rotate-180 transition-all duration-500 dark:scale-100 dark:rotate-0" />
    </Button>
  );
}
